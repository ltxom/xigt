...
def xigt_import(inpath, outpath, options=None):
    ...
    for elem in sorted(sent_Trans.keys()):
        ...
        chunks_in_sent = [k for k, v in chunks.items() if
                          eafob.timeslots[v[0]] > eafob.timeslots[reference[0]] and eafob.timeslots[v[0]] <
                          eafob.timeslots[
                              reference[1]]]
        ...
        notes_in_sent = [c for a, b, c, d in notes if
                         eafob.timeslots[a] > eafob.timeslots[reference[0]] and eafob.timeslots[a] < eafob.timeslots[
                             reference[1]]]
